...
| ~~29~~  | ~~[Issue label taxonomy: 4 axes (type, priority, stage, area)](0029-issue-label-taxonomy.md)~~ | superseded in part by 0038 (axes still in force) |
...
| 38  | [The issue taxonomy lives in `docs/issue-labels.md`, not in `CLAUDE.md`](0038-taxonomy-source-of-truth-in-docs.md) | draft (supersedes 0029 in part) |
