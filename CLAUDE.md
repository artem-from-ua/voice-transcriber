...
Taxonomy lives in [`docs/issue-labels.md`](docs/issue-labels.md) and is applied by the `issue-conventions` plugin — invoke its guide skill before creating or editing issues.
